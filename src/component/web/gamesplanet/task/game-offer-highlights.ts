...
export class GamesplanetGameOfferHighlightsTaskHandler extends ListTaskHandler {
  ...
  protected getGameListContainer (): HTMLElement | undefined {
    ...
    const targetHeading = Array.from(collection).find(e => e.innerText?.toUpperCase() === 'GAME OFFER HIGHLIGHTS');
